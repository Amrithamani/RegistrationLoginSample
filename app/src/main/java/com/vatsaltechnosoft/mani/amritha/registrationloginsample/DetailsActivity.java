...
public class DetailsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    AppCompatTextView textFirst, textLast, textEmail, textUserName, textPasswordView,textPhoneNumber, textHobbies;
    ...
    private void getValues() {
        ...
        textPhoneNumber.setText(intent.getStringExtra("phoneNumber"));
    ...
    private void postDataToSQLite() {
        ...
        /*new AsyncTask<Integer, Long, Boolean>() {
            ...
            protected Boolean doInBackground(Integer... params) {
                ...
                mProgressDialog.setMessage("Opening edit page");
            ...
            protected void onPostExecute(Boolean result) {
                ...
                if (intentUserName.equals(uName)) {
                    ...
                    i.putExtra("phoneNumber",intent.getIntExtra("phoneNumber",0));
