...
public class EditActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    int index;
    TextInputEditText firstName, lastName, emailId, userName, password,phoneNumber, hobbies;
    String uName, textFirst, textLast, textEmail, textUserName, textPasswordView, textPhoneNumber,gender, textHobbies, userType;
    ...
    private void getValues() {
        ...
        textPhoneNumber = intent.getStringExtra("phoneNumber");
